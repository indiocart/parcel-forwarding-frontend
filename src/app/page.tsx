    ...
    <main>
      ...
      <section className="relative text-center py-36 bg-gradient-to-br from-sky-50 via-white to-blue-50 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-6xl md:text-7xl font-extrabold leading-tight mb-6 tracking-tight text-gray-900">
          ...
          <div className="flex justify-center gap-6">
            <button 
              ...
              className="bg-sky-500 hover:bg-sky-600 text-white px-10 py-4 rounded-xl text-lg font-semibold shadow-xl hover:scale-105 transition"
            >
              Start Shopping
            </button>
            ...
            <button 
              ...
              className="border border-sky-500 text-sky-500 px-10 py-4 rounded-xl text-lg font-semibold hover:bg-sky-50 transition"
            >
              How It Works
            </button>
          </div>
      ...
      <section className="px-10 py-20 bg-gray-50">
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-16 max-w-6xl mx-auto">
          ...
          <div className="p-10 rounded-2xl shadow-lg hover:shadow-2xl transition bg-white text-center">
            ...
            <h3 className="text-2xl font-bold mb-3 text-gray-900">Shop Any Indian Website</h3>
          ...
          <div className="p-10 rounded-2xl shadow-lg hover:shadow-2xl transition bg-white text-center">
            <div className="text-5xl mb-4">📦</div>
            <h3 className="text-2xl font-bold mb-3 text-gray-900">We Buy For You</h3>
            <p className="text-gray-600">
          ...
          <div className="p-10 rounded-2xl shadow-lg hover:shadow-2xl transition bg-white text-center">
            ...
            <h3 className="text-2xl font-bold mb-3 text-gray-900">Fast Worldwide Shipping</h3>
            <p className="text-gray-600">
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="bg-slate-100 py-24 px-10">
        ...
        <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="h-56 w-full bg-sky-100 flex items-center justify-center text-6xl">
              🔗
            </div>
            <div className="p-8 text-center">
              <div className="text-4xl mb-3">1️⃣</div>
              <h3 className="text-xl font-bold mb-2 text-gray-900">Send Product Link</h3>
          ...
          {/* Step 2 */}
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="h-56 w-full bg-indigo-100 flex items-center justify-center text-6xl">
              🏪
            </div>
            <div className="p-8 text-center">
              <div className="text-4xl mb-3">2️⃣</div>
              <h3 className="text-xl font-bold mb-2 text-gray-900">We Purchase & Store</h3>
          ...
          {/* Step 3 */}
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="h-56 w-full bg-green-100 flex items-center justify-center text-6xl">
              ✈️
            </div>
            <div className="p-8 text-center">
              <div className="text-4xl mb-3">3️⃣</div>
              <h3 className="text-xl font-bold mb-2 text-gray-900">We Ship Worldwide</h3>
      ...
      <section className="py-24 px-10 bg-white">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="shadow-lg p-8 rounded-xl bg-white border border-gray-100">
            ...
            <h4 className="font-semibold text-gray-900">— Sarah, USA</h4>
          </div>
          ...
          <div className="shadow-lg p-8 rounded-xl bg-white border border-gray-100">
            ...
            <h4 className="font-semibold text-gray-900">— Ahmed, UAE</h4>
          </div>
          ...
          <div className="shadow-lg p-8 rounded-xl bg-white border border-gray-100">
            ...
            <h4 className="font-semibold text-gray-900">— Daniel, UK</h4>
          </div>
      ...
      <section className="py-28 bg-gradient-to-r from-sky-500 to-indigo-500 text-white text-center">
        ...
        <button 
          onClick={() => router.push('/register')}
          className="bg-white text-sky-600 px-10 py-5 rounded-xl text-xl font-bold shadow-xl hover:scale-105 transition"
        >
          Create Free Account
        </button>
      </section>
      ...
      <footer className="bg-slate-900 text-white py-12 px-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">Shop from India. Ship Worldwide.</p>
          </div>

          <div>
            <h4 className="font-semibold mb-2 text-white">Quick Links</h4>
            <p className="text-gray-400 cursor-pointer hover:text-white" onClick={() => router.push('/register')}>Get Started</p>
            <p className="text-gray-400 cursor-pointer hover:text-white" onClick={() => {
              const howItWorks = document.getElementById('how-it-works');
              if (howItWorks) howItWorks.scrollIntoView({ behavior: 'smooth' });
            }}>How it works</p>
            <p className="text-gray-400 cursor-pointer hover:text-white" onClick={() => router.push('/login')}>Login</p>
          </div>

          <div>
            <h4 className="font-semibold mb-2 text-white">Contact</h4>
            <p className="text-gray-400">Email: support@indiocart.com</p>
